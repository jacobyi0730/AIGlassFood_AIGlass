...
//
// End-to-end tests for the reworked AIGlassFood lifecycle flow, driven by MockDeviceKit (which
// simulates Ray-Ban Meta glasses and auto-grants the wearable camera permission) and Compose UI
// automation. Mirrors the iOS AIGlassFoodUITests scenarios.
...
import com.mtvs.food.stream.VideoCaptureHandler
