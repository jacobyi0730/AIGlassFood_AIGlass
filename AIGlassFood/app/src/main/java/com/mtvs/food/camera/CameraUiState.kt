...
data class CameraUiState(
    ...
    // True while the stream-start flow is in flight before the SDK stream state turns STARTING ??    // i.e. while the camera-permission check runs. Folded into isBusy so the Preview button stays
